    ...
    try {
      const response = await fetch("http://localhost:3001/apply_event", {
        ...
        headers: {
          ...
          audience: "http://192.168.1.52:3000",
        },
                ...
                <Card sx={{ height: "100%" }}>
                  ...
                  <Box sx={{ paddingBottom: 1.5 }}>
                    <Button
                      variant="contained"
                      color="primary"
                      onClick={() => handleApplyEvent(eventItem.id)} // handleApplyEvent fonksiyonuna tıklama olayını bağlama
                    >
                      Başvuru Yap
                    </Button>
                  </Box>
